...
func printHelp() {
	fmt.Printf("Usage: qltrq <command> [arguments]\n\n")
	fmt.Println("Commands:")
	fmt.Println("  auth  <token>               Set authentication token from qltrq.old-juniors.uz/auth")
...
func main() {
	...
	default:
		log.Fatalf("unknown command: %s, qltrq --help", command)
	}
	...
	fmt.Printf("qltrq %s \t press Ctrl+C to quit\n\n", version)
	defer log.Println("qltrq tunnel closed")
