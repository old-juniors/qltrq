...
var localConfig = ".qltrq-config"
var remoteConfig = "https://qltrq.old-juniors.uz/config.json"
...
func (c *Config) Load() error {
	...
	if err != nil {
		return fmt.Errorf("error: no auth token, obtain at https://qltrq.old-juniors.uz/auth")
	}
